  ...
  return (
    <div className="mx-4 my-3 lg:max-44 mt-14 min-h-[75vh]">
      <div className="bg-white rounded-lg px-8 py-6 drop-shadow-sm">
        ...
        <div className="flex flex-col sm:grid grid-cols-2 gap-8">
          ...
          <div className="flex flex-col">
            ...
            <div className="rounded-md border border-gray-300 h-full relative bg-layer">
              ...
              {/* <div className='absolute right-1/2 bottom-1/2 transform trnslate-x-1/2 translate-y-1/2'>
        ...
        {/* ---------Buttons -------- */}
        <div className="flex justify-cente sm:justify-end items-center flex-wrap gap-4 mt-6">
